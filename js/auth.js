(function(){
  ...
  const catalog={
    ...
    plate_carrier:{name:'Level III Plate Carrier',weight:7.4,value:5100,rarity:'rare',category:'gear'},
  ...
  const defaultLoadout={head:'helmet',hands:'tactical_gloves',armor:'soft_armor',rig:'chest_rig',backpack:'scav_pack',primary:'ak74',secondary:'makarov'};
