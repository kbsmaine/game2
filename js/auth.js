(function(){
  ...
  const defaultLoadout={head:'helmet',hands:'tactical_gloves',armor:'plate_carrier',front_plate:'armor_plate_lvl3',back_plate:'armor_plate_lvl3',rig:'chest_rig',backpack:'scav_pack',primary:'ak74',secondary:'makarov',_bag:[]};
